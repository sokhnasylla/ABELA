...
import { Button, Container, Card, CardContent, TextField, InputLabel,Select,MenuItem,span} from '@mui/material';

function FormGetInfoHlr() {
    return (
        <div className="">
         <Container sx={{ marginLeft:'12%',marginTop:"10px", width:"50%"}} >
               <Card className='form' sx={{borderRadius:'8px'}}>
               <p  className="title">Extraction des infos HLR</p>
