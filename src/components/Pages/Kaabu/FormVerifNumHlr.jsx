...
import {Container,Card,CardContent,Button,TextField,InputLabel} from '@mui/material'
function FormVerifNumHlr() {
  return (
    <div className="">
    <Container sx={{ marginLeft:'12%',marginTop:"10px", width:"50%"}} >
          <Card className='form' sx={{borderRadius:'8px'}}>
          <p  className="title">Verification d'un numero sur HLR</p>
...
export default FormVerifNumHlr