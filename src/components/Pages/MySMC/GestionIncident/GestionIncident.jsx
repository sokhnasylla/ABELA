...
import { FaPlus, FaSearch, FaThumbsUp } from "react-icons/fa";
...
function GestionIncident() {
  ...
  const reouvertureAvis = (id) => {
    console.log(`Reouverture de l'avis avec id ${id}`);
  };
              ...
              <tbody>
                {currentItemsNotOpen.map((item) => (
                  ...
                  >
                    ...
                    <td>{item.numAvis}</td>
                    <td>{item.titre}</td>
                    <td>{item.etat === "FERME" ? "Fermé" : item.etat}</td>
                        ...
                        <>
                          ...
                          >
                            <Button
                              ...
                              onClick={() => reouvertureAvis(item.id)}
                            >
                              <svg
                                width={15}
                                height={15}
