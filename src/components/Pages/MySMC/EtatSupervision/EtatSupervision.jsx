    ...
    <div id='home'>
        ...
        <Container>
          ...
          <div style={{display:"flex"}}>
             <div  className='mb-4'>
              <Button style={{ backgroundColor:"#5CB85C", borderColor: " #5CB85C",marginRight:"5px",fontSize:"14px",fontWeight:"400"}}><FaCheckCircle /> Alarmes Ok</Button>
             </div>
             <div  className='mb-4'>
              <Button style={{ backgroundColor:" #337ab7", borderColor: " #337ab7",marginRight:"5px",fontSize:"14px",fontWeight:"400"}}><FaChartLine/> VR04H Service</Button>
             </div>
             <div  className='mb-4'>
              <Button style={{ backgroundColor:" #337ab7", borderColor: " #337ab7",marginRight:"5px",fontSize:"14px",fontWeight:"400"}}><FaChartLine/> VR24H Service</Button>
             </div>
             <div  className='mb-4'>
              <Button style={{ backgroundColor:"#337ab7", borderColor: "#337ab7",marginRight:"5px",fontSize:"14px",fontWeight:"400"}}><FaChartLine/> VR04 Application</Button>
             </div>
             <div  className='mb-4'>
              <Button style={{ backgroundColor:"#f0ad4e", borderColor: "#f0ad4e",marginRight:"5px",fontSize:"14px",fontWeight:"400"}}><GoAlertFill/> Gestion Maintenance</Button>
             </div>
             <div  className='mb-4'>
              <Button style={{ backgroundColor:" #d9534f", borderColor: " #d9534f",fontSize:"14px",fontWeight:"400"}}><FaBan/> Historique Désactivation</Button>
             </div>
          </div>
