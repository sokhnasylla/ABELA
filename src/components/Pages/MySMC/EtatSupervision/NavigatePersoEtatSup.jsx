...
function NavigatePersoEtatSup({propsMenuItems, onItemClick}) {
  const getIconComponent = (IconComponent) => {
    return IconComponent ? <IconComponent /> : null;
  };
  return (
    <div className='menuPerso float-end' style={{position:"absolute",top:"48%",marginLeft:"81%",width:"auto"}}>
...
export default NavigatePersoEtatSup