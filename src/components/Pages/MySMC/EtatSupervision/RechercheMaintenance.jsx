...
import {  FaHome, FaList, FaBook,FaDownload,FaShare,FaChartLine,FaBan,FaCheckCircle,FaSearch} from 'react-icons/fa';
    ...
    <div id='home'>
      ...
      <div>
        ...
        <div id='title'>
              ...
              <Title text="Gestion des alarmes en sortie de maintenance" />
              </Col> 
              </Row>
          </div>
          <br />
...
export default RechercheMaintenance