    ...
    return (
        <div className="">
         <Container sx={{ marginLeft:'12%',marginTop:"10px", width:"50%"}} >
               ...
               <p  className="title">Extraction des archives compteurs IN</p>  
                 <CardContent className='p-3' sx={{padding:"0px"}}>
                   ...
                   <div className='mb-4'>
                     ...
                     <div className='mb-4'>
                     <InputLabel id="demo-simple-select-label">MSISDN OU CODE CLIENT</InputLabel>
...
export default FormArchiveCompteur